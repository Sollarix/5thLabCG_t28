...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("F:/Content/quad.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "F:/Content/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "F:/Content/normal_map.jpg");
...
int main(int argc, char** argv)
{
    ...
    if (!GLUTBackendCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, 32, false, "Task 28 Lab 5")) {
        return 1;
    }
